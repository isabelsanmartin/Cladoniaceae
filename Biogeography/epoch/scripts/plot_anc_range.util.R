...
add_island_times = function(p, x_offset) {
    t = "dashed"
    p = p + geom_vline(xintercept=x_offset-55, color="#7570b3", linetype=t)
    p = p + geom_vline(xintercept=x_offset-35, color="#e7298a", linetype=t)
    p = p + geom_vline(xintercept=x_offset-28, color="#e7298a", linetype=t)
    p = p + geom_vline(xintercept=x_offset-20, color="#66a61e", linetype=t)
    p = p + geom_vline(xintercept=x_offset-15, color="#66a61e", linetype=t)
