...
plot_fn = paste(fp, "output_epoch/epoch.range.pdf",sep="")
tree_fn = paste(fp, "output_epoch/output_10000gen_epoch-nodist_BF.ase.tre", sep="")
label_fn = paste(fp, "output_epoch/output_10000gen_epoch-nodist_BF.state_labels.txt", sep="")
color_fn = paste(fp, "output_epoch/range_colors.Clado.txt", sep="")
